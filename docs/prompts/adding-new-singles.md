...
After that, you will create the new maps in docs/maps/{currente date}/\*.{json,yml}

---

# IMPORTANT:

I don't want you to do these steps for ANY classifield/albums/ folder. Only classifield/singles/
