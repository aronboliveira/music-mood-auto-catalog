# Batch 21 — Learning — 2026-04-01 (map `20260401-2`)

## SSBU (5 tracks)

All 5 moved from lean 3–7 mood profiles to rich 11–13 mood sets. Dominant pattern: adding combat moods ({Aggressive, Chaotic, Frenzy, Hardworking}) while dropping generic {Nostalgic, Epic}.
...
All three from Chill-only (1 mood) to 9–11 moods, each distinct:
...
## Fictional-StormPillar (3 tracks)

All share: {Anguished, Dark, Defiant, Explosive, Rebellious, Resigned, Vengeful}. Core = emotional intensity + defiance.
