# Batch 22 — Learning — 2026-04-04 (map `20260404-1`)

## Phase Shift: Enrichment Dominates

Batch 22 is the first where enrichment (18/41 = 44%) is the primary change pattern. This
marks the transition from correction-of-errors (batches 19–21) to a completeness phase
where tracks already have correct but shallow profiles (1–3 moods) that are expanded to
full descriptive sets (6–13 moods).

## SSBU / Game OST (4 tracks changed + 2 newly reviewed)

All 4 changed SSBU/game tracks lost {Nostalgic, Epic} in favor of combat-specific profiles:

- **Battle!-Trainer-Fictional-SapphireShield (SM)**: 4→8 — Aggressive/Chaotic/Frenzy/Rebellious replace Epic+Nostalgic
- **Escape-from-the-City (SA2)**: 7→13 — Fictional-StormSwan Adventure 2 run-track quality fully represented with Defiant/Ecstatic/Frenzy/Groovy/Heroic/Rebellious/Yearning
...
- **Chaos/punk** (Another-Girl-Another-Planet, MORE-THAN-YOU-KNOW): Aggressive/Chaotic/Frenzy/Vengeful
- **Dark complexity** (No-Heart-To-Speak-Of 2→14): one of the largest single-track expansions — {Anguished, Desperate, Gritty, Heartbreak, Lonely, Melancholic, Nostalgic, Rebellious, Sad, Tense}
...
Three Brazilian pop/soul tracks demonstrating a full tonal range:

- **Pra-Ver-o-Sol-Brilhar**: sunny/romantic → Joyful/Optimistic/Romantic/Tender
...
- **Going,-Going,-Gone**: +Melancholic/Nostalgic/Resigned
- **Knockin'-On-Heaven's-Door**: +Peaceful/Reverent/Serene/Spiritual
