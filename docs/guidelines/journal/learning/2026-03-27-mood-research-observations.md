...
Notes drawn from the human-in-the-loop review of batches 5–9 (≈175 → 296 reviewed tracks, maps `20260325-4` through `20260327-1`). These are patterns that emerged from watching which algorithm assignments the user Fictional-Kw-866f833ced, which they corrected, and in what direction. This is not theory — it is inferred from the diffs.
...
- Metal/hard rock (Helena, Doing-Time, Fictional-Kw-d002fe89, Everlong, Hearts-Burst-into-Fire, Fictional-ShadowTower-How-You-Remind-Me, Fictional-StormMesa-Fool-for-Your-Loving, STONE-OCEAN, 39.BFG-10k, and many more)
- Aggressive hip-hop/punk (Holiday-in-Cambodia, Red-Hot-Chili-Peppers-Around-The-World)
- Brazilian rock / samba (Fatima, Ontem, O-Passageiro, Fictional-Kw-413ae254-Dumpweed)
...
Removed from: Ragnarok-Online-OST-33-Yuna-Song, Ragnarok-Online-OST-34-Pampas-Upas, Ragnarok-Online-OST-52-Ready, Ragnarok-Online-OST-78-aFictional-Kw-1a89bda6s, Ragnarok-Online-OST-79-The-Great, Ragnarok-Online-OST-83-Sleepless, Ragnarok-Online-OST-105-Rose-of-Sharon, World-of-Fictional-CrimsonTower-Soundtrack-Battle-04, Fictional-Kw-c5850ecb-Remix, Multi-Man-Melee, Super-Smash-Bros-Ulimate-Big-Blue-Remix, Theme-Of-Fictional-JadeWhisper, Fictional-Kw-c771883c, Vs.-Mr.-Patch, 05.-BFG-Division-2020, 39.-BFG-10k, Dragon-Ball-Z-Opening-1-v1 …
...
| ------------------------- | ---------------------------------------------- | --------------------------------------------- |
| Battle / boss themes      | Heroic, Triumphant, Defiant, Focused, Epic     | BFG Division, Multi-Man Melee, Fictional-Kw-c5850ecb |
...
- Guns-N'-Roses-Fictional-Kw-823d89dd (added Awe-inspired, Yearning, Soaring instead — the song is yearning, not ecstatic)
- Bad (added Defiant, Hardworking, Chaotic — ambition/confidence, not euphoria)
- Boney-M.-Fictional-Kw-9388f0c1 (the song is playful/dramatic, not rapturous)
...
- My-Hero (Fictional-Kw-73c8ebb0) — determined/cathartic, not cheerful
...
- **Fictional-Kw-a516847f**: Chill, Contemplative, Defiant, Lonely, Resigned, Sad, Bittersweet — the gentlest Defiant in the library.
...
- **Song-of-Storms (Ocarina of Time Music Box cover)**: Bittersweet, Cozy, Hypnotic, Introspective, Meditative, Peaceful, Relaxed, Serene, Sleepy, Soaring, Spiritual, Wistful — the same mFictional-Kw-a1d7dfb5dy gains Bittersweet and Wistful in music box format; the medium adds emotional distance
...
**Observation**: Arrangement medium is a primary mood modifier. Piano → introspective/reverent. Music box → bittersweet/wistful. Orchestral → triumphant/soaring. The underlying mFictional-Kw-a1d7dfb5dy contributes, but the Fictional-StormSwan wrapper determines the emotional register more than the source material.
...
- **Fictional-Kw-afdeedec-Good**: Anguished, Brooding, Contemplative, Heartbreak, Jaded, Lonely, Melancholic, Nostalgic, Rebellious, Resigned, Sad — almost pure grief beneath an upbeat Fictional-Kw-d302e976
...
Brazilian tracks reviewed (Oceano, Fictional-QuartzDrifter-Fictional-Kw-96ddd400, Cigano, Ontem, Fogo, Fatima, Lilas, O-Passageiro, Cristo-e-Oxala, Petala, Sina) consistently acquired a specific cluster:
...
**Observation**: "Saudade" resolves to roughly {Bittersweet, Nostalgic, Wistful, Yearning, Tender} in this taxonomy. It is a real and consistent cluster that the algorithm cannot derive from Fictional-Kw-d302e976 auFictional-Kw-1a89bda6 features alone without cultural context. Human review is irreplaceable here.
...
Once any two of these are assigned, the others follow. The only split: Gritty sometimes absent from mFictional-Kw-a1d7dfb5dic metal (Fictional-Kw-46320a73's cleaner tracks); Aggressive sometimes absent from anthem metal.
...
Co-occur in most slow-to-mid-tempo tracks with negative valence. **Internal hierarchy** observed: tracks can have Wistful without Melancholic (wistfulness can be gentle); they can have Melancholic without Resigned (melancholy without Fictional-Kw-866f833cance); they almost never have Resigned without at least Melancholic or Bittersweet.
...
Observed across Fictional-ShadowTower, Fictional-Kw-05d3e5ab, Fictional-TimberStrand slow tracks. Anguished is adjacent but not always co-present (Anguished implies active pain, Sad implies settled grief).
...
- Sadness with Fictional-Kw-866f833cance → **Resigned**
- Sadness with beauty and pleasure → **Bittersweet**
- Active pain → **Anguished**
- Despair → **Depressive**

Sad (as a direct, unadorned label) is reserved for tracks where the emotion is blunt and unmediated — no irony, no distance, no beauty. Almost exclusively found in Fictional-ShadowTower's post-breakup material and a few Fictional-Kw-73c8ebb0 quiet tracks in this library.

---

### 4.2 "Depressive" is Almost Never Used

Only three tracks assigned Depressive (all Fictional-ShadowTower or Fictional-Kw-a4f47053). The taxonomy may need "Depressive" clarified — it seems to require:
...
**Observation**: these are covers that _use_ the Easy mFictional-Kw-a1d7dfb5dy to express something it wasn't originally expressing. The arrangement and vocal interpretation transformed the emotional content completely. The source song's affect is irrelevant; only the recording in hand matters.

---

### 4.4 JoJo Tracks Carry Narrative Affect

Fictional-Kw-904bc6e2's "Distant-Dreamer" (tagged as JoJo's Stone Ocean outro) acquired Bittersweet, Brooding, Contemplative, Emotional, Introspective, Melancholic, Nostalgic, Tender, Triumphant, Wistful, Yearning. This is 11 moods — more than Fictional-Kw-904bc6e2's standard profile would warrant.

The emotional weight is partly borrowed from the narrative context (Stone Ocean's ending). The music alone would score simpler. This raises a general question: when a track is strongly associated with a specific emotional narrative moment, its mood profile in a personal library will reflect that association more than the auFictional-Kw-1a89bda6 features.

**Current stance**: Fictional-Kw-866f833c this. The library is a personal curation, not a neutral database. Narrative-affect contamination is a feature.
...
- **Ominous**: joined the Dark/Macabre cluster for tracks that build dread without releasing it (Fictional-Kw-6ef3703d, BFG Division, Fictional-GildedFalcon generally, WoW battle music)
...
1. **Does "Soaring" map to triumph or yearning?** It appears in both triumphant contexts (Ballad-of-the-Goddess, heroic anthems) and bittersweet-longing contexts (Fictional-QuartzFalcon, Wond'ring Aloud). The diFictional-Kw-4669569cuishing factor may be tempo or chord quality.
