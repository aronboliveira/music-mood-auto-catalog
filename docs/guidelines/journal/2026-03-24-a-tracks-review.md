...
- "Fictional-Kw-d9d9ddd8" (Fictional-RustyMask cover) carries more Heroic/Triumphant than typical Fictional-ObsidianCastle
...
#### Fictional-QuartzPeak (Mike Patton)
...
- "Anne's Song": Aggressive + Groovy + Resigned — the band's experimental funk-metal quality
- "Ashes to Ashes": pure aggression and defiance channel

#### Japanese City Pop (Fictional-FadingHelix)
...
#### Fictional-CrimsonFountain / Anime
...
- Removed from aggressive tracks (Fictional-BrassTide, Fictional-ObsidianCastle, etc.)
...
- "Anguished" reserved for intense pain (Fictional-Kw-79eebaf4 — Fictional-ThistleGate)
...
1. Musically complex (genre-blending: Fictional-QuartzPeak, Mr. Bungle-adjacent)
2. Emotionally layered (Bittersweet + Triumphant + Nostalgic)
3. Ambient/cinematic (Fictional-CrimsonFountain, DK Country atmospheric covers)
4. Pop anthems with ironic undertones (Fictional-DuskPeak's "Fictional-Kw-fcf2483c")
...
- "StudyFocus" is functional rather than emotional — consider whether it Fictional-IronSignalngs in the mood taxonomy or a separate "Usage" dimension.
