# Batch 22 — Statistics — 2026-04-04 (map `20260404-1`)
...
| Reviewed tracks | 555 → 595 (+40, 61.3% coverage)  |
| Mood changes    | 41 tracks                        |
| Folder sync     | 353 copies, 35 removes, 65/65 OK |
| Avg moods/track | 7.10 → 7.43 (+0.33)              |

First batch where **enrichment dominates** (18/41 = 44%).
...
Shift from correction-of-errors phase (batches 19–21) toward a completeness phase.
...
Chill–Energetic gap: **8** (392 vs 384). Down from 21 last batch. Four consecutive batches of convergence. At this rate, Energetic will surpass Chill in the next batch.
